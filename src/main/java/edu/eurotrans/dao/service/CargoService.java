...
import edu.eurotrans.api.dto.CargoDTO;
import edu.eurotrans.api.request.SearchCriteriaRequest;
import edu.eurotrans.dao.entity.EmployeeEntity;
import edu.eurotrans.dao.entity.WorkTripCargoHistory;
import edu.eurotrans.dao.entity.WorkTripEntity;
import edu.eurotrans.dao.repository.jooq.EmployeeEntityRecord;
import edu.eurotrans.dao.repository.jooq.WorkTripCargoHistoryJooqRepo;
import edu.eurotrans.dao.repository.jpa.EmployeeJpaRepository;
import edu.eurotrans.dao.repository.jpa.WorkTripJpaRepository;
import edu.eurotrans.dao.repository.jpa.WorkTripCargoHistoryRepository;
import edu.eurotrans.util.EmailUtil;
