...
import edu.eurotrans.dao.jooq.tables.records.TagRecord;
...
public class Tag extends TableImpl<TagRecord> {
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(
            Internal.createIndex(DSL.name("idx_tag_name"), Tag.TAG, new OrderField[] { Tag.TAG.NAME }, false)
        );
    }
    ...
    public UniqueKey<TagRecord> getPrimaryKey() {
        return Internal.createUniqueKey(Tag.TAG, DSL.name("tag_pkey"), new TableField[] { Tag.TAG.ID }, true);
    }
