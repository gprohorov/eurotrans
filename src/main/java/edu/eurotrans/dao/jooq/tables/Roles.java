...
import edu.eurotrans.dao.jooq.tables.records.RolesRecord;
...
public class Roles extends TableImpl<RolesRecord> {
     ...
     */
    public final TableField<RolesRecord, String> ROLE = createField(DSL.name("role"), SQLDataType.VARCHAR(30), this, "");
