...
import edu.eurotrans.dao.jooq.tables.records.EmployeeExpensesRecord;
...
public class EmployeeExpenses extends TableImpl<EmployeeExpensesRecord> {
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(
            Internal.createIndex(DSL.name("idx_employee_expenses_name"), EmployeeExpenses.EMPLOYEE_EXPENSES, new OrderField[] { EmployeeExpenses.EMPLOYEE_EXPENSES.NAME }, false), 
            Internal.createIndex(DSL.name("idx_employee_expenses_salary"), EmployeeExpenses.EMPLOYEE_EXPENSES, new OrderField[] { EmployeeExpenses.EMPLOYEE_EXPENSES.VALUE }, false)
        );
    }
    ...
    public UniqueKey<EmployeeExpensesRecord> getPrimaryKey() {
        return Internal.createUniqueKey(EmployeeExpenses.EMPLOYEE_EXPENSES, DSL.name("employee_expenses_pkey"), new TableField[] { EmployeeExpenses.EMPLOYEE_EXPENSES.ID }, true);
    }
