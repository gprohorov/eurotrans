 ...
 */
package edu.eurotrans.dao.jooq.tables;


import edu.eurotrans.dao.jooq.Public;
import edu.eurotrans.dao.jooq.tables.records.WorkTripRecord;
...
public class WorkTrip extends TableImpl<WorkTripRecord> {
    ...
    /**
     * The column <code>public.work_trip.salary_rate</code>.
     */
    public final TableField<WorkTripRecord, Float> SALARY_RATE = createField(DSL.name("salary_rate"), SQLDataType.REAL.nullable(false).defaultValue(DSL.inline("1", SQLDataType.REAL)), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function12<? super Long, ? super String, ? super String, ? super Integer, ? super Integer, ? super Integer, ? super Integer, ? super Boolean, ? super LocalDateTime, ? super LocalDateTime, ? super Integer, ? super Float, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function12<? super Long, ? super String, ? super String, ? super Integer, ? super Integer, ? super Integer, ? super Integer, ? super Boolean, ? super LocalDateTime, ? super LocalDateTime, ? super Integer, ? super Float, ? extends U> from) {
