...
import edu.eurotrans.dao.jooq.tables.records.CurrencyRecord;
...
public class Currency extends TableImpl<CurrencyRecord> {
     ...
     */
    public final TableField<CurrencyRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(16).nullable(false), this, "");
    ...
    public UniqueKey<CurrencyRecord> getPrimaryKey() {
        return Internal.createUniqueKey(Currency.CURRENCY, DSL.name("currency_pkey"), new TableField[] { Currency.CURRENCY.ID }, true);
    }
